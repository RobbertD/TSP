function tspgui_path_tournament()
...
crossover_set = {'xalt_edges', 'order_high_level', 'pmx'};
...
set(fh,'Visible','on');
    ...
    function runbutton_Callback(hObject,eventdata)
        ...
        run_ga_path_tournament(x, y, NIND, MAXGEN, NVAR, ELITIST, STOP_PERCENTAGE, PR_CROSS, PR_MUT, CROSSOVER, MUTATION, LOCALLOOP,  TWO_OPT, k, ah1, ah2, ah3);
        end_run();
    end
